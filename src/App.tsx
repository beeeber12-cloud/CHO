...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#EFF1F3] text-[#1A1C21] pb-[calc(5.5rem+env(safe-area-inset-bottom))] md:pb-10 font-sans">
      <PWAInstallPrompt />
      {/* Dynamic Header */}
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-[#E3E4E7] shadow-sm">
        <div className="max-w-4xl mx-auto px-2.5 sm:px-4 py-2.5 flex justify-between items-center gap-1.5">
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#EDEEF0] rounded-xl flex items-center justify-center text-[#2C2F36] shrink-0">
              <BookMarked size={18} className="sm:w-5 sm:h-5" />
            </div>
            <div className="shrink-0">
              <h1 className="font-bold text-base sm:text-lg text-[#2C2F36] tracking-tight leading-none whitespace-nowrap">은혜교회</h1>
              <span className="text-2xs sm:text-2xs text-[#4B4E55] font-bold uppercase tracking-wider block whitespace-nowrap">말씀 묵상 나눔방</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            ...
            {/* Profile badge */}
            <div className="flex items-center gap-1.5 bg-[#F4F5F7] border border-[#E3E4E7] px-2 sm:px-3 py-1 sm:py-1.5 rounded-2xl text-2xs sm:text-xs text-[#4B4E55] whitespace-nowrap">
              <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#2C2F36] text-white font-bold rounded-full flex items-center justify-center text-2xs sm:text-2xs shrink-0">
                {currentUser.name.slice(-2)}
              </div>
              <span className="font-bold text-[#4B4E55] truncate max-w-[80px] sm:max-w-none">
            ...
            <button
              ...
              className="p-1.5 text-[#85888F] hover:text-[#2C2F36] hover:bg-[#F4F5F7] rounded-2xl transition cursor-pointer shrink-0"
              title="로그아웃"
            >
              <LogOut size={16} />
            </button>
      ...
      <main className="max-w-4xl mx-auto px-1 sm:px-4 py-2 sm:py-6">
        ...
        <div className="hidden md:grid grid-cols-7 gap-1.5 border-b border-[#E3E4E7] bg-[#F4F5F7] p-1 rounded-2xl">
          <button
            onClick={() => setActiveTab('notice')}
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'notice' ? "bg-[#2C2F36] text-white shadow-sm" : "text-[#85888F] hover:text-[#2C2F36]"
            }`}
          >
            <BookOpen size={15} />
            오늘 말씀
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'feed' ? "bg-[#2C2F36] text-white shadow-sm" : "text-[#85888F] hover:text-[#2C2F36]"
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'gratitude' ? "bg-[#2C2F36] text-white shadow-sm" : "text-[#85888F] hover:text-[#2C2F36]"
            }`}
          >
            <HeartHandshake size={15} className={activeTab === 'gratitude' ? "text-[#FFFFFF]" : "text-[#4B4E55]"} />
            오늘의 감사
          </button>
          <button
            onClick={() => setActiveTab('bible')}
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'bible' ? "bg-[#2C2F36] text-white shadow-sm" : "text-[#85888F] hover:text-[#2C2F36]"
            }`}
          >
            <BookMarked size={15} />
            성경 읽기방
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'my' ? "bg-[#2C2F36] text-white shadow-sm" : "text-[#85888F] hover:text-[#2C2F36]"
            }`}
          >
            <Calendar size={15} />
            나의 기록
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'qna' ? "bg-[#2C2F36] text-white shadow-sm" : "text-[#85888F] hover:text-[#2C2F36]"
            }`}
          >
            <HelpCircle size={15} />
            성경 Q&A
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'settings' ? "bg-[#2C2F36] text-white shadow-sm" : "text-[#85888F] hover:text-[#2C2F36]"
            }`}
          >
            <Bell size={15} />
            알림 설정
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-[#E3E4E7] shadow-[0_-2px_15px_rgba(0,49,31,0.06)] px-1 pt-1 flex items-center justify-around overflow-x-auto pb-[max(0.25rem,env(safe-area-inset-bottom))]">
        <button
          onClick={() => {
            setActiveTab('notice');
          ...
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'notice' ? "text-[#2C2F36]" : "text-[#85888F]"
          }`}
        >
          <BookOpen size={17} />
        ...
        <button
          onClick={() => setActiveTab('feed')}
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'feed' ? "text-[#2C2F36]" : "text-[#85888F]"
          }`}
        >
        ...
        <button
          onClick={() => setActiveTab('gratitude')}
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'gratitude' ? "text-[#2C2F36] font-extrabold" : "text-[#85888F]"
          }`}
        >
          <HeartHandshake size={17} className={activeTab === 'gratitude' ? "text-[#4B4E55]" : ""} />
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'bible' ? "text-[#2C2F36]" : "text-[#85888F]"
          }`}
        >
          <BookMarked size={17} />
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'my' ? "text-[#2C2F36]" : "text-[#85888F]"
          }`}
        >
          <Calendar size={17} />
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'qna' ? "text-[#2C2F36] font-extrabold" : "text-[#85888F]"
          }`}
        >
          <HelpCircle size={17} className={activeTab === 'qna' ? "text-[#4B4E55]" : ""} />
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'settings' ? "text-[#2C2F36]" : "text-[#85888F]"
          }`}
        >
          <Bell size={17} />
