...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F7FA] text-[#1C1C1E] pb-20 md:pb-10 font-sans">
      <PWAInstallPrompt />
      {/* Dynamic Header */}
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-[#E5E5EA] shadow-sm">
        <div className="max-w-4xl mx-auto px-2.5 sm:px-4 py-2.5 flex justify-between items-center gap-1.5">
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[#E3F2E9] rounded-xl flex items-center justify-center text-[#14603F] shrink-0">
              <BookMarked size={18} className="sm:w-5 sm:h-5" />
            </div>
            <div className="shrink-0">
              <h1 className="font-bold text-base sm:text-lg text-[#14603F] tracking-tight leading-none whitespace-nowrap">은혜교회</h1>
              <span className="text-[9px] sm:text-[10px] text-[#17784C] font-bold uppercase tracking-wider block whitespace-nowrap">말씀 묵상 나눔방</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            ...
            {/* Profile badge */}
            <div className="flex items-center gap-1.5 bg-[#F2F2F7] border border-[#E5E5EA] px-2 sm:px-3 py-1 sm:py-1.5 rounded-2xl text-[11px] sm:text-xs text-[#3A3A3C] whitespace-nowrap">
              <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#14603F] text-white font-bold rounded-full flex items-center justify-center text-[9px] sm:text-[10px] shrink-0">
                {currentUser.name.slice(-2)}
              </div>
              <span className="font-bold text-[#3A3A3C] truncate max-w-[80px] sm:max-w-none">
            ...
            <button
              ...
              className="p-1.5 text-slate-400 hover:text-[#14603F] hover:bg-[#F2F2F7] rounded-2xl transition cursor-pointer shrink-0"
              title="로그아웃"
            >
              <LogOut size={16} />
            </button>
      ...
      <main className="max-w-4xl mx-auto px-1 sm:px-4 py-2 sm:py-6">
        ...
        <div className="hidden md:grid grid-cols-7 gap-1.5 border-b border-[#E5E5EA] bg-[#F2F2F7] p-1 rounded-2xl">
          <button
            onClick={() => setActiveTab('notice')}
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'notice' ? "bg-[#14603F] text-white shadow-sm" : "text-[#8E8E93] hover:text-[#14603F]"
            }`}
          >
            <BookOpen size={15} />
            오늘 말씀
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'feed' ? "bg-[#14603F] text-white shadow-sm" : "text-[#8E8E93] hover:text-[#14603F]"
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'gratitude' ? "bg-[#14603F] text-white shadow-sm" : "text-[#8E8E93] hover:text-[#14603F]"
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'bible' ? "bg-[#14603F] text-white shadow-sm" : "text-[#8E8E93] hover:text-[#14603F]"
            }`}
          >
            <BookMarked size={15} />
            성경 읽기방
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'my' ? "bg-[#14603F] text-white shadow-sm" : "text-[#8E8E93] hover:text-[#14603F]"
            }`}
          >
            <Calendar size={15} />
            나의 기록
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'qna' ? "bg-[#14603F] text-white shadow-sm" : "text-[#8E8E93] hover:text-[#14603F]"
            }`}
          >
            <HelpCircle size={15} />
            성경 Q&A
          ...
          <button
            ...
            className={`flex items-center justify-center gap-1.5 py-2.5 rounded-2xl text-xs font-bold transition cursor-pointer ${
              activeTab === 'settings' ? "bg-[#14603F] text-white shadow-sm" : "text-[#8E8E93] hover:text-[#14603F]"
            }`}
          >
            <Bell size={15} />
            알림 설정
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-[#E5E5EA] shadow-[0_-2px_15px_rgba(44,62,45,0.05)] px-1 py-1 flex items-center justify-around overflow-x-auto">
        <button
          onClick={() => {
            setActiveTab('notice');
          ...
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'notice' ? "text-[#14603F]" : "text-[#8E8E93]"
          }`}
        >
          <BookOpen size={17} />
        ...
        <button
          onClick={() => setActiveTab('feed')}
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'feed' ? "text-[#14603F]" : "text-[#8E8E93]"
          }`}
        >
        ...
        <button
          onClick={() => setActiveTab('gratitude')}
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'gratitude' ? "text-[#14603F] font-extrabold" : "text-[#8E8E93]"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'bible' ? "text-[#14603F]" : "text-[#8E8E93]"
          }`}
        >
          <BookMarked size={17} />
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'my' ? "text-[#14603F]" : "text-[#8E8E93]"
          }`}
        >
          <Calendar size={17} />
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'qna' ? "text-[#14603F] font-extrabold" : "text-[#8E8E93]"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-1.5 rounded-2xl transition cursor-pointer min-w-[50px] ${
            activeTab === 'settings' ? "text-[#14603F]" : "text-[#8E8E93]"
          }`}
        >
          <Bell size={17} />
