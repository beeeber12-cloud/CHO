    ...
    <div className="space-y-4 sm:space-y-6">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 self-stretch md:self-auto border-t border-white/10 pt-3 md:pt-0 md:border-t-0">
            <div className="text-center bg-white/10 px-3 py-2.5 rounded-2xl min-w-[75px]">
              ...
              <span className="text-[10px] text-emerald-100/70 font-semibold block">묵상 작성</span>
              <strong className="text-base sm:text-lg font-black">{totalWritten}회</strong>
            </div>

            <div className="text-center bg-amber-400/20 border border-amber-300/30 px-3 py-2.5 rounded-2xl min-w-[75px]">
              <div className="flex justify-center text-amber-300 mb-0.5">
                <HeartHandshake size={16} />
              </div>
              <span className="text-[10px] text-amber-100/90 font-semibold block">감사 작성</span>
              <strong className="text-base sm:text-lg font-black text-amber-200">{totalGratitudes}회</strong>
            </div>
            ...
            <div className="text-center bg-white/10 px-3 py-2.5 rounded-2xl min-w-[75px]">
              ...
              <span className="text-[10px] text-emerald-100/70 font-semibold block">기록한 날</span>
            ...
            <div className="text-center bg-white/10 px-3 py-2.5 rounded-2xl min-w-[75px]">
              ...
              <span className="text-[10px] text-emerald-100/70 font-semibold block">연속 일수</span>
              <strong className="text-base sm:text-lg font-black text-amber-200">{activeStreak}일</strong>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-[#ece8df] shadow-sm p-4 space-y-3">
        ...
        <div className="flex gap-2 border-t border-[#ece8df] pt-3 text-xs font-bold">
          ...
          >
            <span>전체 기록</span>
            <span className="text-[10px] bg-white/20 px-1.5 py-0.2 rounded-full">{totalWritten + totalGratitudes}</span>
          </button>
          <button
          ...
          >
            <BookOpen size={13} />
            <span>말씀 묵상</span>
            <span className="text-[10px] bg-white/20 px-1.5 py-0.2 rounded-full">{totalWritten}</span>
          </button>
          <button
          ...
          >
            ...
            <span>오늘의 감사</span>
            <span className="text-[10px] bg-white/20 px-1.5 py-0.2 rounded-full">{totalGratitudes}</span>
          </button>
        </div>
      </div>
            ...
            if (item.type === 'meditation') {
              ...
              return (
                <motion.div
                  ...
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-amber-50/40 rounded-3xl border border-amber-200/80 shadow-sm p-5 space-y-4 hover:border-amber-300 transition-colors"
                >
                  <div className="flex justify-between items-start">
                    <div className="flex items-center gap-2.5">
                      <div className="w-9 h-9 bg-amber-600 text-white font-bold rounded-full flex items-center justify-center text-xs shadow-sm">
                      ...
                      <div>
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="bg-amber-100 text-amber-800 border border-amber-200 text-[9px] font-black px-2 py-0.5 rounded-full flex items-center gap-1">
                            <Sparkles size={10} className="text-amber-600" /> 오늘의 감사
                          </span>
                        </div>
                        <div className="flex items-center gap-1 text-[10px] text-amber-800/70 mt-0.5 font-medium">
                          <Clock size={10} />
                  ...
                  <p className="text-xs text-slate-800 leading-relaxed whitespace-pre-line bg-white/90 p-4 rounded-2xl border border-amber-200/60 font-medium">
                    {grat.content}
                  </p>
                  ...
                  <div className="flex items-center justify-between border-t border-amber-200/60 pt-3">
                    <div className="flex items-center gap-4">
                      <button
                        ...
                        className={`flex items-center gap-1.5 text-[11px] font-bold transition cursor-pointer ${
                          hasLiked ? "text-rose-600" : "text-amber-800/70 hover:text-rose-500"
                        }`}
                      >
                        <Heart size={14} className={hasLiked ? "fill-rose-600 text-rose-600" : ""} />
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1.5 text-[11px] font-bold transition cursor-pointer ${
                          commentsOpen ? "text-amber-900" : "text-amber-800/70 hover:text-amber-900"
                        }`}
                      >
                        <MessageSquare size={14} />
                    ...
                    {grat.likes.length > 0 && (
                      <div className="text-[9px] text-amber-800/70 font-medium">
                  ...
                  {commentsOpen && (
                    <div className="bg-amber-100/50 border border-amber-200/70 rounded-2xl p-4 space-y-3 mt-2">
                      {grat.comments.length > 0 ? (
                        ...
                        <p className="text-[10px] text-amber-800/70 text-center py-2">
